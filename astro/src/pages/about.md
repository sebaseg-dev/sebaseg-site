...
J’ai passé presque six ans au sein du même groupe, à différents postes financiers et à différents niveaux. J’ai souvent constaté que la complexité des systèmes pouvait rendre les outils difficiles à manipuler. Ces observations m’ont donné envie de concevoir des applications simples et cohérentes, où chaque fonctionnalité a du sens et apporte une valeur réelle.

Pour y parvenir, je me suis formé au développement web (React, JavaScript, Symfony). Aujourd’hui, je conçois des interfaces fonctionnelles, centrées sur les besoins concrets des utilisateurs. Mon intention est de gérer la complexité en amont, pour proposer des solutions claires et efficaces. L’objectif : permettre à ceux qui utilisent mes outils de comprendre, maîtriser et s’approprier les sujets sans se perdre dans des logiques opaques.
...
Cette transition me permet de combiner deux univers : la rigueur et la précision de l’environnement légal et financier, avec la flexibilité et l’expérimentation du code. Mon objectif est simple : simplifier les workflows, rendre l’information accessible et concevoir des applications qui facilitent la vie des utilisateurs.
